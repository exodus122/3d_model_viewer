...
// cutter plane's height above (x,z), which is only well-defined for a
// substantially horizontal poly - a vertical/near-vertical one either has no
// height (ny == 0 -> computeYFromPlaneLocal returns 0) or a wildly exaggerated
// one (tiny ny -> division blowup). Matches subdivisions.js's floor threshold.
const TOPCUT_MIN_CUTTER_NY = 0.5;
