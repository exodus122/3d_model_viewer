...
export function parseCollisionHeader(dv, addr, address_offset, colHeader, endianness) {
...
export function parseWaterboxes(dv, colHeader, address_offset, endianness, waterBoxes) {
...
export function parseVerticesAndPolygons(dv, colHeader, address_offset, endianness, poly_length, verts, tris, intangibleTris, intangibleTriangleData, allTriangleData) {
    // Get Vertices
